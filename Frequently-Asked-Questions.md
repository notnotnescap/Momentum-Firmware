> [!WARNING]
> This documentation is still a work in progress. This section will contain answers to common questions and issues.
>
...
*WARNING*: This will delete all the data on the SD card and you'll need to install again. Refer to the [Backup methods](https://github.com/Next-Flip/Momentum-Firmware/wiki/Installation#back-up-your-data) before proceeding.
