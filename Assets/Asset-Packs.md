...
> You can jump to the full list of Asset Packs [here](https://github.com/Next-Flip/Momentum-Firmware/wiki/Community-Asset-Packs).
...
- Fill those folders appropriately, referring to the information and structure above, BUT:
    ...
    > [!NOTE]
    > THIS IS ALL JUST LIKE IN OFFICIAL FIRMWARE, YOU'RE JUST DOING IT IN ANOTHER FOLDER.
